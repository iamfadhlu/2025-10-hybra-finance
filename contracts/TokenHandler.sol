...
contract TokenHandler is  ITokenHandler {
    ...
    event Hybralisted(address indexed blacklister, address indexed token);
    event WhitelistedNFT(address indexed whitelister, uint256 tokenId);
    event HybralistNFT(address indexed whitelister, uint256 tokenId);
    event WhitelistedConnector(address indexed whitelister, address indexed token);
    event HybralistConnector(address indexed whitelister, address indexed token);
    ...
    /// @notice Hybralist a malicious token
    ...
    function _blacklist(address _token) private {
        ...
        emit Hybralisted(msg.sender, _token);
    }
    ...
    function blacklistNFT(uint256 _tokenId) external Governance() {
        ...
        emit HybralistNFT(msg.sender, _tokenId);
    }
    ...
    function blacklistConnector(address _token) external Governance() {
        ...
        emit HybralistConnector(msg.sender, _token);
    }
